...
export class InformeGeneralComponent implements OnInit {
  ...
  createChart() {
    ...
    const giros = this.terceraSeccion.find(item => item.Clasificacion === 'Giros') || { Clasificacion: 'Giros', ENE: 0, FEB: 0, MAR: 0, ABR: 0, MAY: 0, JUN: 0, JUL: 0, AGO: 0, SEP: 0};
